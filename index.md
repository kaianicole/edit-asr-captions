...
### Speaker names
If you have more than one voice speaking, you should capture who is speaking. To do so, add the speaker's name before the caption segment each time the speaker switches.
- Do not add the speaker information before every caption segment
